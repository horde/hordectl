...
/**
 * Factory for /api/v1/admin/applications requests
 *
 * Creates PSR-7 HTTP requests for the applications list endpoint.
 *
 * @category Horde
 * @package  Hordectl
 * @author   Ralf Lang <ralf.lang@ralf-lang.de>
 * @license  http://www.horde.org/licenses/lgpl21 LGPL 2.1
 */
class ApplicationsRequestFactory
{
    /**
     * Constructor
     *
    ...
    /**
     * Create HTTP request for /api/v1/admin/applications endpoint
     *
     * @return RequestInterface PSR-7 request
     */
    public function create(): RequestInterface
    {
        $url = $this->config->getApiBaseUrl() . '/admin/applications';
