...
/**
 * Factory for GET /api/v1/admin/identities/:username requests
 *
 * @category Horde
 * @package  Hordectl
 * @author   Ralf Lang <ralf.lang@ralf-lang.de>
 * @license  http://www.horde.org/licenses/lgpl21 LGPL 2.1
 */
class ListIdentitiesRequestFactory
{
    /**
     * Constructor
     *
    ...
    /**
     * Create HTTP request for listing user identities
     *
     * @return RequestInterface PSR-7 request
     */
    public function create(): RequestInterface
    {
        $url = $this->config->getApiBaseUrl() . '/admin/identities/'
